...
class BankAccount{
	...
	void deposit(int amount) // amount is parameter using  this is the 1 st method
	{
		if(amount !=0)
		{
	...
	void withdraw(int amount)// 2 method
	{
		if(amount !=0)
		{
			balance =balance -amount;
	...
	void showmenu() {
		int option='\0';//intiallize with any value
		Scanner scanner=new Scanner(System.in);
		...
		System.out.println("---------------------------------------------------------------------------------------------------");
		option=scanner.next().charAt(0);//reding  charecter from counsolo
		System.out.println("  ");
		...
		System.out.println("E. tgetBalance");
		...
		do {
			...
			switch(option) {//this variables compare with each cases
			case '1':
				System.out.println("---------------------------------------------------------------------------------------------------");
